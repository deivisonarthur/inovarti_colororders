...
/** Rewrite de Mage_Adminhtml_Block_Sales_Order_Status_New_Form */

/**
 * Create order status form
 */
class Inovarti_ColorOrders_Block_Adminhtml_Block_Widget_New extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('admin_color_order', 'text',
            array(
                'label'     => 'Admin color(HEX)',
                'name'      => 'admin_color_order'
            )
        );
