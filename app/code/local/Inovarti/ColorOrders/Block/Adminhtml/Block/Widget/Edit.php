...
/** Rewrite de Mage_Adminhtml_Block_Sales_Order_Status_Edit_Form */

/**
 * Edit status form
 */
class Inovarti_ColorOrders_Block_Adminhtml_Block_Widget_Edit extends Inovarti_ColorOrders_Block_Adminhtml_Block_Widget_New
{
